#' plots the O-E CUSUM for each facility/center strata
#'
#' The function takes the information for survival analysis and returns the signal situation and plots
#'
#' @param date The day you use the function
#' @param ESCO_ord Grouping strata of the center/facility
#' @param data_path The path you saved the data
#' @param facility_id_name The column name of facility id
#' @param start_name The column name of entering follow up for each subject
#' @param end_name The column name of ending follow up for each subject
#' @param dial_drd_name The column name of qualifying deaths
#' @param xbeta_name The column name of adjusted risk
#' @param patient_id_name The column name of subject id
#' @param start_date The start date of the follow up (calendar time)
#' @param end_date The end date of the follow up (calendar time)
#' @param HPT1 The H_1 of deterioration
#' @param HPT2 The H_1 of improvement
#' @param Lambda_list_prior The unadjusted national average hazard rate for each subject i
#' @param year_event_rate The risk
#' @param pre Name of the center/facility
#' @param ESCO_de_identified_path Path of facility/center strata
#' @param y_axis_path Path of y_axis
...
#' @examples
#' Mortality_CUSUM(date,ESCO_ord,"data_all.csv","facility_id_name","start_name","end_name",
...
#' #Output: graphs
#' @export
O_E.CUSUM<-function(date,ESCO_ord,data_path,facility_id_name,start_name,end_name,
                          dial_drd_name,xbeta_name,patient_id_name,start_date,end_date,
                          HPT1,HPT2,Lambda_list_prior,year_event_rate,pre,
                          ESCO_de_identified_path,y_axis_path,h_val_path,rho){
#
